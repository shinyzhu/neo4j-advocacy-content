...
![img](neo4j-visualization-tools-intro/clip_image005.png)Neovis.js是一个JavaScript库，帮助开发者使用Neo4j图数据创建图可视化。Neovis.js是流行的库Vis.js的封装，在Cypher和浏览器中定制图可视化之间提供了一座桥梁。
